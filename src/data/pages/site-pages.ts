...
export const sitePages: PageContent[] = [
  {
    ...
    faqIds: [],
    relatedPageIds: ["fixed-identity-overview-en-us", "privacy-policy", "terms"],
  ...
  },
  {
    ...
    faqIds: [],
    relatedPageIds: ["fixed-identity-overview-en-us", "contact", "terms"],
    schemaTypes: ["Article", "BreadcrumbList"],
    sourceStatus: "internal",
    lastReviewed: "2026-09-09",
  },
  {
    ...
    faqIds: [],
    relatedPageIds: ["fixed-identity-overview-en-us", "contact", "privacy-policy"],
    schemaTypes: ["Article", "BreadcrumbList"],
    sourceStatus: "internal",
    lastReviewed: "2026-09-09",
  },
